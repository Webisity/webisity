...
export default function Example() {
  return (
    <div className="relative bg-white">
      <div className="bg-green-200 absolute inset-0" aria-hidden="true">
        <div className="absolute inset-y-0 right-0 w-1/2 bg-indigo-200" />
      </div>
      <div className="relative max-w-7xl mx-auto lg:px-8 lg:grid lg:grid-cols-2">
        <div className="bg-slate-200 py-16 px-4 sm:py-24 sm:px-6 lg:px-0 lg:pr-8">
          <div className="bg-yellow-200 max-w-lg mx-auto lg:mx-0">
            ...
            <dl className="bg-pink-200 mt-12 space-y-10">
        ...
        <div className="bg-indigo-700 py-16 px-4 sm:py-24 sm:px-6 lg:bg-none lg:px-0 lg:pl-8 lg:flex lg:items-center lg:justify-end">
          <div className="bg-green-200 max-w-lg mx-auto w-full space-y-8 lg:mx-0">
            <div>
              <h2 className="sr-only">Price</h2>
              <p className="relative grid grid-cols-2">
                <span className="bg-red-200 flex flex-col text-center">
                ...
                <span>
                  <span className="bg-pink-200 flex flex-col text-center">
