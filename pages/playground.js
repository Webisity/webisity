...
export default function Playground() {
  return (
    ...
    <div className="bg-pink-400 relative pt-8 pb-16 sm:pb-24 lg:pb-8">
      {/* <Popover>
        <nav
      ...
      <main className="bg-green-200 mx-auto max-w-7xl px-4 sm:px-6 ">
        <div className="bg-slate-400 lg:grid lg:grid-cols-2 lg:gap-8">
          <div className="bg-pink-400 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-1 lg:text-left">
            <h1>
          ...
          <div className="bg-red-800 mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-1 lg:flex lg:items-center">
            <svg
            ...
            <div className="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
              ...
              >
                ...
                <img
                  className="w-full"
                  src="https://LorellaPalmerLTD.b-cdn.net/responsive%201600.png" height={350} width={350}
                  alt=""
                />
